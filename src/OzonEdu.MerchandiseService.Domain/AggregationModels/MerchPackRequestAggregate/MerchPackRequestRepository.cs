...
namespace OzonEdu.MerchandiseService.Domain.AggregationModels.MerchPackRequestAggregate
{
    public class MerchPackRequestRepository : IMerchPackRequestRepository
    {
        ...
        public Task<MerchPackRequest> CreateAsync(MerchPackRequest merchPackRequest, CancellationToken cancellationToken = default)
        {
        ...
        public Task<MerchPackRequest?> FindByRequestNumberAsync(RequestNumber requestNumber, CancellationToken cancellationToken = default)
        {
